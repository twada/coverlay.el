...
(defun coverlay-test-setup (data-file)
  ...
  (coverlay-create-stats-buffer (concat dir data-file)))
...
(expectations
   ...
   (expect 5
     (setq dir (file-name-directory (buffer-file-name (current-buffer))))
     (with-current-buffer (get-buffer-create "*coverlay-stats.csv*")
       (erase-buffer)
   ...
   (expect 1
     (with-current-buffer (coverlay-test-setup "coverage_stats.csv")
       (csv-forward-field 0)
       (point)
       ))
   (expect 21
   ...
   (desc "coverlay-current-csv-field-to-string")
   (expect "/path/to/app/init.js"
     (with-current-buffer (coverlay-test-setup "coverage_stats.csv")
       (coverlay-current-csv-field-to-string)))

   (desc "coverlay-next-csv-field-to-string")
   (expect 1
     (with-current-buffer (coverlay-test-setup "coverage_stats.csv")
       (string-to-number (coverlay-next-csv-field-to-string))))
   (expect 2
     (with-current-buffer (coverlay-test-setup "coverage_stats.csv")
       (coverlay-next-csv-field-to-string)
       (string-to-number (coverlay-next-csv-field-to-string))))

   (desc "coverlay-current-csv-line-to-list")
   (expect '("/path/to/app/init.js" 1 2)
     (with-current-buffer (coverlay-test-setup "coverage_stats.csv")
       (coverlay-current-csv-line-to-list)))
   ...
   (expect '("/path/to/app/init.js" 6 4)
     (with-current-buffer (coverlay-test-setup "coverage_stats.csv")
       (assoc "/path/to/app/init.js" (coverlay-parse-buffer (current-buffer)))
       ))
   (expect '("/path/to/app/init.js" 8 8 6 4)
     (with-current-buffer (coverlay-test-setup "coverage_stats2.csv")
       (assoc "/path/to/app/init.js" (coverlay-parse-buffer (current-buffer)))
       ))
   (expect '("/path/to/lib/utils.js" 82 82 76 76 70 70 62 62 55 55 38 37 29 27 24 22 17 17 6 4)
     (with-current-buffer (coverlay-test-setup "coverage_stats3.csv")
       (assoc "/path/to/lib/utils.js" (coverlay-parse-buffer (current-buffer)))
       ))
   (expect '("/path/to/app/init.js" 20 19)
     (with-current-buffer (coverlay-test-setup "coverage_stats4.csv")
       (assoc "/path/to/app/init.js" (coverlay-parse-buffer (current-buffer)))
       ))
   (expect '("/path/to/lib/utils.js" 82 82 76 76 70 70 62 62 55 55 38 37 29 27 24 22 17 17 6 4)
     (with-current-buffer (coverlay-test-setup "coverage_stats4.csv")
   ...
   (expect '("/path/to/app/init.js" 4 6 8 8)
     (with-current-buffer (coverlay-test-setup "coverage_stats2.csv")
       (setq rev-alist (coverlay-reverse-cdr-of-alist (coverlay-parse-buffer (current-buffer))))
   ...
   (expect '((4 6) (17 17) (22 24) (27 29) (37 38) (55 55) (62 62) (70 70) (76 76) (82 82))
     (setq stats-buf (coverlay-test-setup "coverage_stats4.csv"))
   ...
   (desc "coverlay-create-stats-alist-from-buffer bug reproduction")
   (expect '((4 6) (17 17) (22 24) (27 29) (37 38) (55 55) (62 62) (70 70) (76 76) (82 82))
     (setq stats-buf (coverlay-test-setup "coverage_stats4_reverse.csv"))
     (setq stats-alist (coverlay-create-stats-alist-from-buffer stats-buf))
     (cdr (assoc "/path/to/lib/utils.js" stats-alist)))
   (expect '((19 20))
     (setq stats-buf (coverlay-test-setup "coverage_stats4_reverse.csv"))
   ...
   (expect '((2 2) (80 80) (95 95) (203 204) (210 211) (217 222) (224 224) (226 226) (235 238) (245 245) (250 255) (290 290)  (300 303) (305 310) (360 360))
     (setq stats-buf (coverlay-test-setup "coverage_stats5.csv"))
     (setq stats-alist (coverlay-create-stats-alist-from-buffer stats-buf))
